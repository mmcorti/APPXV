...
const KNOWN_PROPERTIES = {
    ...
    GUESTS: {
        ...
        AllottedAdults: ["Allotted Adults", "Cupos Adultos"],
        AllottedTeens: ["Allotted Teens", "Cupos Jóvenes", "Cupos Jovenes"],
        AllottedKids: ["Allotted Kids", "Cupos Niños", "Cupos Ninos"],
        AllottedInfants: ["Allotted Infants", "Cupos Bebés", "Cupos Bebes"],
        ConfirmedAdults: ["Confirmed Adults", "Confirmados Adultos"],
        ConfirmedTeens: ["Confirmed Teens", "Confirmados Jóvenes", "Confirmados Jovenes"],
        ConfirmedKids: ["Confirmed Kids", "Confirmados Niños", "Confirmados Ninos"],
        ConfirmedInfants: ["Confirmed Infants", "Confirmados Bebés", "Confirmados Bebes"],
