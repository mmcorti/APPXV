    ...
    <div className="flex-1 flex flex-col w-full max-w-[480px] md:max-w-xl mx-auto overflow-x-hidden min-h-screen justify-between bg-background-light dark:bg-background-dark">
      ...
      <form className="flex flex-col gap-4 mt-6 px-6" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl h-14 px-5 bg-white dark:bg-slate-800 text-gray-700 dark:text-white text-base font-semibold border border-gray-200 dark:border-gray-600 shadow-sm hover:shadow-md hover:scale-[1.01] active:scale-[0.99] transition-all"
        >
