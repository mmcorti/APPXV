          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800">
              ...
              <p className="text-sm font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
                El salón cuenta con valet parking y estacionamiento privado. El ingreso principal es por la recepción del hotel.
              </p>
            </div>
          </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/10 p-5 rounded-3xl border border-blue-100 dark:border-blue-900/30 flex gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed mt-1">
              Se recomienda solicitar transporte privado (Uber/Cabify) para mayor comodidad al finalizar el evento.
            </p>
          </div>
        </div>
      </div>
